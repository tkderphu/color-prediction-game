...
public class LoginFrame extends javax.swing.JFrame {
    ...
    public LoginFrame(ClientConnection connection) {
        ...
        // Thêm ActionListener cho nút Login
    ...
    private void handleLogin() {
        ...
        Message message = new Message(Instruction.LOGIN, loginRequest);
        clientConnection.sendMessage(message);

        try {
            Message responseMessage = (Message) clientConnection.readMessage();
            Object payload = responseMessage.getPayload();

            if (payload instanceof LoginResponse) {
                LoginResponse loginResponse = (LoginResponse) payload;
                new HomeFrame(loginResponse.getUser(), clientConnection).setVisible(true);
                this.dispose();
            } else if (payload instanceof ErrorResponse) {
                ErrorResponse error = (ErrorResponse) payload;
                JOptionPane.showMessageDialog(this, error.getMessage(), "Lỗi Server", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Phản hồi không hợp lệ từ server", "Lỗi", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Lỗi khi giao tiếp với server: " + e.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    }
